...
#                 "file:/eos/cms/store/data/Commissioning2018/ZeroBias/RAW/v1/000/314/444/00000/1E0F4919-EF41-E811-B5E9-FA163EA348D9.root",
                  "/store/data/Run2018B/ZeroBias/RAW/v1/000/317/340/00000/FE3D5FBB-7666-E811-AB72-FA163E405EA6.root",  # change file to ZeroBias?  Which one is the right one though?
                 VarParsing.VarParsing.multiplicity.list,
                 VarParsing.VarParsing.varType.string,
                 "Input files")

options.register('outputFile',
                 "HcalTupleMaker_317340.root", # default value
                 # If this includes a path as well it will not work
                 #"/afs/cern.ch/user/a/amohamme/PFG/CMSSW_10_1_1/src/HCALPFG/HcalTupleMaker/test/Plots_7_18/HcalTupleMaker_317340.root", # default value
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 "Output file")
...
process.hcalTupleQIE11Digis.chargeSkim = cms.untracked.double(50)
#------------------------------------------------------------------------------------
# Specify Global Tag
#------------------------------------------------------------------------------------
